...
//        System.out.println("pnbMap:"+pnbMap.size());
    ...
    public Set<Integer> queryM(int queryId, int queryK, MetaPath queryMPath,int queryN,int queryM){
        this.queryId = queryId;
        this.queryMPath = queryMPath;
        this.queryK = queryK;
        this.queryN = queryN;
...
//        System.out.println("pnbMap:"+pnbMap.size());
    ...
    public Set<Integer> queryMP(int queryId, int queryK, MetaPath queryMPath,int queryN,int queryM){
        this.queryId = queryId;
        this.queryMPath = queryMPath;
        this.queryK = queryK;
        this.queryN = queryN;
...
//        System.out.println("pnbMap:"+pnbMap.size());
    ...
    private Map<Integer, Set<Integer>> buildGraph() {
        ...
        Set<Integer> keepSet = mixIndex.search(queryId,queryK,queryN,datafile,indexfile);
        keepSet.add(queryId);
