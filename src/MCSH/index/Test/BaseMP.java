...
//        int vertex[] = {1, 0, 1},edge[] = {9 , 21};//PMP
        ...
        try {
            ...
            File logfile = new File(Config.ResultFile + "Basem" + 1 + "_" + queryMPath.toString() + ".txt");
            File logfile2 = new File(Config.ResultFile + "BasemP" + 1 + "_" + queryMPath.toString() + ".txt");
            ...
            for (int queryid:querynodes){
                ...
                Set<Integer> result = baseline1.queryM(queryid,queryK,queryMPath,4);
                ...
                baseline1 baseline2 = new baseline1(graph,vertexType,edgeType,attribute,adistance);
                Set<Integer> result2 = baseline2.queryM_protect(queryid,queryK,queryMPath,4);
