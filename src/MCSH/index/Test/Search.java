...
//        List<MetaPath> Mplist = new ArrayList<>();
        ...
        try {
            ...
            File logfile = new File(Config.ResultFile + "IBm" + 1 + "_" + queryMPath.toString() + ".txt");
            File logfile2 = new File(Config.ResultFile + "IBmP" + 1 + "_" + queryMPath.toString() + ".txt");
...
//                IndexBasedSearch indexBasedSearch = new IndexBasedSearch(graph,vertexType,edgeType,attribute,adistance);
//                Set<Integer> result = indexBasedSearch.query(queryid,queryK,queryMPath,(float) 1.0);
                IBSearch ibSearch = new IBSearch(graph,vertexType,edgeType,attribute,adistance,"");
                Set<Integer> result = ibSearch.queryM(queryid,queryK,queryMPath,(float) 1.0,4);
...
//                    Set<Integer> result = indexBasedSearch.query(queryid,queryK,queryMPath,v2);
                ...
                Set<Integer> result2 = ibSearch2.query_save(queryid,queryK,queryMPath,(float) 1.0,4);
