...
//        DataReader dataReader = new DataReader(Config.dblpGraph, Config.dblpVertex, Config.dblpEdge, null,Config.dblpattributed);
        ...
        String datafile2 = "/home/hadoop/2.txt";
        String idnexfile1 = "/home/hadoop/1.n2";
...
//        String idnexfile = "/home/hadoop/MCSH/CSH/CSHDS/DBLP/indexM_50ef_600_new.n2";
        ...
        index.build(datafile2,idnexfile2, gweight.getbuildweight(), 77,2,20,600);

        index.increbuild(datafile1,idnexfile2,idnexfile1,50,gweight.getbuildweight(), 77,2,20,600);
        ...
        while(flag<100){
            ...
            int[] m =  index.search(attribute.get(queryid),K,ef,idnexfile1,gweight.getbuildweight(),77,2);
