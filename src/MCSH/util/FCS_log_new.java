...
public class FCS_log_new {
    ...
    public Set<Integer> findCompactC(Map<Integer,Set<Integer>> pnbmap,Set<Integer> keepset,Adistance_float adistance,int queryId,int queryK){
        System.out.println("logmap delete one");
...
//        System.out.println("cal all dist");
...
//        System.out.println("cal all distance:"+(t2-t1));
        ...
        float[] minavgdist = new float[3];
//        long t3 = System.nanoTime();
        minavgdist[0] = adistance.cal_subgraph_attr_dist_new2(denstcc,distancemap,minavgdist);
//        long t4 = System.nanoTime();
//        System.out.println("cal communcity avgdist:"+(t4-t3));
        do {
//            System.out.println("find smaller cc");
    ...
    public Set<Integer> findCompactC(Map<Integer,Set<Integer>> pnbmap,Set<Integer> keepset,int M,Adistance_float adistance,int queryId,int queryK){
        System.out.println("logmap delete m");
        //step 1: initialization
//        long t1 = System.nanoTime();
        Map<Integer, Map<Integer,Float>> distancemap = new HashMap<>();
        for(int i:keepset){
...
//            System.out.println("one Iteration:"+(t4-t3));
    ...
    public Set<Integer> findCompactC_protect(Map<Integer,Set<Integer>> pnbmap,Set<Integer> keepset,int queryM,Adistance_float adistance,int queryId,int queryK){
        System.out.println("logmap delete mp");
        //step 1: initialization
        Map<Integer, Map<Integer,Float>> distancemap = new HashMap<>();
        for(int i:keepset){
            distancemap.put(i,new HashMap<>());
...
//            System.out.println("one Iteration:"+(t4-t3));
    ...
    private Set<Integer> find_distsmallcc_deleteone_new(Map<Integer, Set<Integer>> pnbmap, Set<Integer> keepset, Map<Integer, Map<Integer,Float>> distancemap, int k, int queryid, float[] lastdistance, Adistance_float adistance) {
        //计算每个节点的属性得分并排序
//        long t1 = System.nanoTime();
//        System.out.println("cal score");
...
//                Set<Integer> set = new HashSet<>(keepset);
//                set.removeAll(community);
...
//            System.out.println("recover map");
