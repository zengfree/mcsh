...
//
        ...
        try {
            ...
            for(int queryid:querynodes){
                ...
                File file = new File("map_fsq0-0-3-6-0.txt");
                ...
                File attfile = new File("att_fsq.txt");
                stdin = new BufferedReader(new FileReader(attfile));
                Map<Integer,Set<Integer>> att = new HashMap<>();
                while((line = stdin.readLine()) != null){
                    String[] s = line.split(" ");
                    int key = Integer.parseInt(s[0]);
                    Set<Integer> set = new HashSet<>();
...
//                adistance.setYu((float) 0.5);
                ...
                ATC new_graph = new ATC(map,att);
                Set<Integer> st = new HashSet<Integer>(att.get(queryid));
