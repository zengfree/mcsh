...
//        int[] edge = {3, 0};
        ...
        try {
            ...
            File logfile = new File("ktest/baselogmap_" + queryK + "_"  + queryM + "_"+ queryMPath + ".txt");
            ...
            for(int queryid:querynodes){
                ...
                exec.submit(()->{
                    try{
                        ...
                        Base_logmap2 b1 = new Base_logmap2(graph,vertexType,edgeType,attribute,adistance);
