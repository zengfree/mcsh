...
//        String queryfile ="/home/hadoop/dblequerynodes.txt";
        ...
        try {
            ...
            File logfile = new File( "ktest/basemlogmap_" + queryK + "_"  + queryM + "_"+ queryMPath + ".txt");
            ...
            for(int queryid:querynodes){
                ...
                exec.submit(()->{
                    try{
                        ...
                        Base_logmap2 bs1 = new Base_logmap2(graph,vertexType,edgeType,attribute,adistance);
                        Set<Integer> result = bs1.queryM(queryid,queryK,queryMPath,queryM);
