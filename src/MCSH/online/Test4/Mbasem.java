    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for(int i=2;i<=20;i = i+2) {
                File logfile = new File(Config.ResultFile + args[0] + "/mtest/basem" + i + "_" +queryK  + "_"+ queryMPath.toString() + ".txt");
                ...
                for (int queryid:querynodes){
                    ...
                    exec.submit(()->{
                        try{
                            ...
                            Set<Integer> result2 = bl2.queryM(queryid,queryK,queryMPath, finalI);
