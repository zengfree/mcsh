...
public class baseline1 {
    ...
    public baseline1(int[][] graph, int[] vertexType, int[] edgeType, Map<Integer, float[]> attributed , Adistance_float adistance) {
        this.graph = graph;
    ...
    public Set<Integer> query2(int queryId, int queryK, MetaPath queryMPath){
        ...
        //step 3:
        FCS_corefind fcs = new FCS_corefind();

        return fcs.findC(pnbMap,cc, this.adistance,queryId,queryK);
    }

    public Set<Integer> query_test(int queryId, int queryK, MetaPath queryMPath){
        this.queryId = queryId;
        this.queryMPath = queryMPath;
        this.queryK = queryK;
...
//        System.out.println("pnbMap:"+pnbMap.size());
        ...
        //step 3:
        FCS_copy findCloseCommunity = new FCS_copy();
    ...
    public Set<Integer> queryM(int queryId, int queryK, MetaPath queryMPath,int m){
        ...
        return findCloseCommunity.findCompactC(pnbMap,cc,m, this.adistance,queryId,queryK);
    }
    ...
    public Set<Integer> queryM_test(int queryId, int queryK, MetaPath queryMPath,int m){
        this.queryId = queryId;
        this.queryMPath = queryMPath;
        this.queryK = queryK;
    ...
    public Set<Integer> queryM_protect_test(int queryId, int queryK, MetaPath queryMPath,int m){
        this.queryId = queryId;
        this.queryMPath = queryMPath;
        this.queryK = queryK;
