...
//    private int queryId = -1;//the query vertex id
    ...
    public CoreDec(int[][] graph, int[] vertexType, int[] edgeType) {
        this.graph = graph;
...
//
//
//        int vertex[] = {1, 0, 1}, edge[] = {3, 0}; //MPM
//        MetaPath qPath = new MetaPath(vertex, edge);
//
//        File logfile = new File( "core_new.txt");
