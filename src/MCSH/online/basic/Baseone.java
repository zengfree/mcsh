...
public class Baseone {
    ...
    public Baseone(int[][] graph, int[] vertexType, int[] edgeType, Map<Integer, float[]> attributed , Adistance_float adistance) {
        this.graph = graph;
    ...
    public Set<Integer> query(int queryId, int queryK, MetaPath queryMPath){
        ...
        return one1.findCompactC(pnbMap,cc, this.adistance,queryId,queryK);
    }
