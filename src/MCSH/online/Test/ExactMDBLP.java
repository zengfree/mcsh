...
import MCSH.online.exact.ExactAlgorithm_advance;
...
//        String queryfile = "C:\\Users\\Sward\\Desktop\\query\\smalldblequery1.txt";
        ...
        try {
            ...
            File logfile = new File(Config.ResultFile + "exact_ad_dblp_"  + queryMPath.toString() + ".txt");
            if (!logfile.exists()) {
            ...
            for (int queryid:querynodes){
                ...
                ExactAlgorithm_advance exactAlgorithm = new ExactAlgorithm_advance(graph,vertexType,edgeType,null,attribute,adistance);
