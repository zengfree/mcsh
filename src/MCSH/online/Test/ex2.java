...
//                Set<Integer> res1 = base.queryM_protect(queryid,queryK,queryMPath,queryM);
                ...
                if(res1!=null){
                    ...
                    avgdist2+=dist;
                    avgt2+=(t4-t3)/1e6;
                    System.out.println("e2:"+dist);
                    System.out.println("e2 time:" +(t4-t3)/1e6+"ms");
                }

//                adistance.setYu((float) 0.45);
//                long t5 = System.nanoTime();
//                ExactAlgorithm_float e = new ExactAlgorithm_float(graph,vertexType,edgeType,attribute,adistance,8);
//                Set<Integer> res2 = e.query2(queryid,queryK,queryMPath);
//                long t6 = System.nanoTime();
//                if(res2!=null){
//                    float dist = adistance.cal_subgraph_attr_dist(res2);
//                    avgdistE+=dist;
//                    avgt1+=(t6-t5)/1e6;
//                    System.out.println("e3:"+dist);
//                    System.out.println("e3:" +(t6-t5)/1e6+"s");
//                }
...
//                Set<Integer> res2 = basemp.queryM_protect(queryid,queryK,queryMPath,queryM);
//                Set<Integer> res2 = basemp.queryM(queryid,queryK,queryMPath,queryM);
//                Set<Integer> res2 = basemp.query(queryid,queryK,queryMPath);


                MNindex app = new MNindex(graph,vertexType,edgeType,attribute,adistance,40);
                Set<Integer> res2 = app.query(queryid,queryK,queryMPath);
//                Set<Integer> res2 = app.queryM(queryid,queryK,queryMPath,queryM);
//				Set<Integer> res2 = app.queryM_protect(queryid,queryK,queryMPath,queryM);
...
//                Set<Integer> res2 = result.keySet();
                if(res2!=null){
                    ...
                    Set<Integer> set = new HashSet<>(res2);
                    assert res1 != null;
                    set.retainAll(res1);
                    avgpre += (float) set.size()/res2.size();
